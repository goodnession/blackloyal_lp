...
<script setup>
const openFAQs = ref(Array(8).fill(false))
...
useHead({
  title: 'FAQ - Часто задаваемые вопросы - BlackLoyal',
  description: 'Ответы на популярные вопросы о BlackLoyal: интеграция, настройка, безопасность, поддержка и многое другое.',
})
</script>
